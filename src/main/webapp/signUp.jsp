...
<head>
	...
	<div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
		<form class="border p-3 rounded" style="width: 35%;" method="POST" action="RegistrazioneServlet">
			<h3 class="text-center mb-3">Registrazione</h3>

			<div class="mb-3">
				<label for="name" class="form-label">Nome</label>
				<input type="text" class="form-control" id="name" name="nome" placeholder="Inserisci il tuo nome completo" required onkeyup="isName()">
			</div>
			<div class="mb-3">
				<label for="name" class="form-label">Cognome</label>
				<input type="text" class="form-control" id="cognome" name="cognome" placeholder="Inserisci il tuo nome completo" required onkeyup="isName()">
				<span id="messageName">
				</span>
			</div>
			<div class="mb-3">
				<label for="email" class="form-label">Indirizzo email</label>
				<input type="email" class="form-control" id="email" name="e-mail" placeholder="Inserisci la tua email" required onkeyup="isEmail()">
			...
			<div class="d-flex justify-content-center">
				<button type="submit" name="submit" id="submit" class="btn btn-primary">Registrati</button>
			</div>
		</form>
	</div>
