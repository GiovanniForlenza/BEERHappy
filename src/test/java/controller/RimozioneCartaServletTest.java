...
class RimozioneCartaServletTest {
	@Mock
	...
	@InjectMocks
	private RimozioneCartaServlet servlet;

	@BeforeEach
	void setUp() throws ServletException {
		MockitoAnnotations.openMocks(this);
		when(request.getSession()).thenReturn(session);
		servlet = new RimozioneCartaServlet();
		servlet.init();
	}

	@Test
	void RimozioneCartaServlet() throws ServletException, IOException {
		...
		when(request.getParameter("cartaID")).thenReturn("1");
